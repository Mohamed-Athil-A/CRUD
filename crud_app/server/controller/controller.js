...
//retrive and return all users / retrive return a sing user
exports.find = (req, res) => {
  if (req.query.id) {
    ...
    Userdb.find() // this find() will return all the user info from the database
      .then((user) => {
        res.send(user);
      })
      .catch((err) => {
...
//Delete a user with soecified user id in the request
